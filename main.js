...
const getChatResponse = async (incomingChatDiv) => {
  ...
  // animasyonunu ekrandan kaldırma
...
const handleOutGoingChat = () => {
  // chatInput un valuesunu alma ve fazladan bosluklari silme
  ...
  // kullanicinin mesajini iceren bir div olusturup bunu chatcontainer yapisina ekleme.
...
// Enter tuşuna basıldığında istek atar
